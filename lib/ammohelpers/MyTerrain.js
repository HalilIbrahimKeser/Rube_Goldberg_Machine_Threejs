...
export const myTerrain = {
	...
	addTerrain() {
		getHeightData('../assets/images/heightmap3.png', 128, 128, this.terrainHeightLoaded.bind(this));
	},
	...
	terrainHeightLoaded(heightData) {
		...
		textureLoader.load( "../assets/images/grass_tile.png", ( texture ) => {
			...
			let groundMaterial = new THREE.MeshLambertMaterial( { color: 0xC7C7C7, side: THREE.DoubleSide } );
